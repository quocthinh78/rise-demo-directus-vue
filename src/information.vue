<template>
  <private-view title="My Custom Module">
    <div>
      <!-- Modal code adapted from https://flowbite.com/docs/getting-started/vue/ -->
...
onMounted(async () => {
  ...
  // Use interval to ensure ref exists upon rendering
  const interval = setInterval(() => {
    if (modalElement.value) {
      clearInterval(interval);

      // Create modal
      sampleModal = new Modal(modalElement.value, modalOptions);
